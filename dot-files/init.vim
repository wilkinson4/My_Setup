...
let g:ale_reason_ls_executable = '/Users/wwilkinson/.config/nvim/reason-language-server'
...
let g:suggest_db = "psql -U $DB_DEVPG"
...
hi ALEWarning gui=undercurl guifg=Yellow
...
highlight NormalNC guibg=#4a4343
...
autocmd BufReadPost */pg-schemas/*.sql setlocal makeprg=devpg errorformat=psql:\/%f\:%l\:\ ERROR:\ \ %m
